...
public class KnoocraftPlayerListener extends PlayerListener {
	...
	public void onPlayerMove(PlayerMoveEvent event) {
		...
		/* ------------------------------------------------------ */
			...
			Note.Tone tones[] = { Note.Tone.A, Note.Tone.B, Note.Tone.C,
					Note.Tone.D, Note.Tone.E, Note.Tone.F, Note.Tone.G };
			...
			if (fy < ty)
				player.getServer()
						.broadcastMessage(
								(new KcMessaging())
										.format("<gray/>*claps*<pink/> J'ump! <gray/>*claps*"));
